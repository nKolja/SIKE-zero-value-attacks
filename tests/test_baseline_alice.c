...
*
* Computation of baseline Alice public keys, which force Bob to compute one inversion of zero, and one random inversion
*********************************************************************************************/ 
#include <stdio.h>
#include <string.h>
...
int main(int argc, char* argv[])
{
    ...
    Status = baseline_alice_keys(argc, argv);             // Alice key generation 
    if (Status != PASSED) {
        printf("\n\n   Error detected! \n\n");
        return FAILED;
    }
